...
public class HTTP {
     ...
     */
    public static Response getResponse(final String url , final Map<String, String> headers) {
    ...
    public static Response deleteResponse(final String url) {
        return deleteResponse( url , null );
    }
    
    /**
     * Does a delete but you get a Response object
     *
     * @param url
     * @param headers
     * @return Response object
     */
    public static Response deleteResponse(final String url , final Map<String, String> headers) {
    ...
    public static Response jsonRestCallViaPOST(
        ...
        return postBodyTextWithContentTypeReturnResponse(url, APPLICATION_JSON, null, jsonString);
    }
    
    public static Response jsonRestCallViaPOSTWithHeaders(
            final String url,
            final Map<String, ?> headers,
            final String jsonString) {

        return postBodyTextWithContentTypeReturnResponse(url, APPLICATION_JSON, headers, jsonString);
    }
    ...
    public static Response jsonRestCallViaPUT(
        ...
        return putBodyTextWithContentTypeReturnResponse(url, APPLICATION_JSON, null, jsonString);
    }

	public static Response jsonRestCallViaPUTWithHeaders(
            final String url,
            final Map<String, ?> headers,
            final String jsonString) {

        return putBodyTextWithContentTypeReturnResponse(url, APPLICATION_JSON, headers, jsonString);
    }
    ...
    public static Response putBodyTextWithContentTypeReturnResponse(final String url,
        ...
        return Exceptions.tryIt(Response.class, new Exceptions.TrialWithReturn<Response>() {
            ...
            public Response tryIt() throws Exception {
                URLConnection connection;
                connection = doPut(url, headers, contentType, null, body);
                return extractResponseObject(connection);
            }
        });
