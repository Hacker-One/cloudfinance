...
public class DateUtils {
    ...
    public static String getAroundDateByHour(int cycleNum, String inDate, String format) {
        ...
        DateTime dt = new DateTime(Integer.parseInt(inDate.substring(0, 4)), Integer.parseInt(inDate.substring(4, 6)), Integer.parseInt(inDate.substring(6, 8)), Integer.parseInt(inDate.substring(8, 10)), Integer.parseInt(inDate.substring(10, 12)), Integer.parseInt(inDate.substring(12, 14)), 0);
